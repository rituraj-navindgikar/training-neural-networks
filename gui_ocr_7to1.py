...
def train_callback():
    ...
    for i in range(epochs):
        mse = 0.0
        mse += sdrnn.back_propagation([1,1,1,1,1,1,0],[0.05])    #0 pattern
        mse += sdrnn.back_propagation([0,1,1,0,0,0,0],[0.15])    #1 pattern
        mse += sdrnn.back_propagation([1,1,0,1,1,0,1],[0.25])    #2 pattern
        mse += sdrnn.back_propagation([1,1,1,1,0,0,1],[0.35])    #3 pattern
        mse += sdrnn.back_propagation([0,1,1,0,0,1,1],[0.45])    #4 pattern
        mse += sdrnn.back_propagation([1,0,1,1,0,1,1],[0.55])    #5 pattern
        mse += sdrnn.back_propagation([1,0,1,1,1,1,1],[0.65])    #6 pattern
        mse += sdrnn.back_propagation([1,1,1,0,0,0,0],[0.75])    #7 pattern
        mse += sdrnn.back_propagation([1,1,1,1,1,1,1],[0.85])    #8 pattern
        mse += sdrnn.back_propagation([1,1,1,1,0,1,1],[0.95])    #9 pattern
